...
public class ItemUtils {
    ...
    public static class Builder {
        ...
        public Builder(@Nullable GenCore plugin, @NotNull Material material) {
            this(plugin, material, 1);
        }

        public Builder(@Nullable GenCore plugin, @NotNull ItemStack itemStack) {
            this.plugin = plugin;
            this.itemStack = itemStack;
        }

        public Builder(@Nullable GenCore plugin, @NotNull Material material, int amount) {
            this.plugin = plugin;
